"""pages/sources.py - Haive sources page."""
...
<div class="sources-page">
  <section class="src-hero">
    <div class="src-inner">
      ...
      <div class="src-sub">
        The documents and references behind Haive's product structure,
    ...
    <div class="src-inner">
      <div class="src-section-head">
        ...
        <div class="src-section-copy">
          Haive was assembled from a small, deliberate source set: the
      ...
      <div class="src-grid">
        <div class="src-source">
          <div class="src-source-title">Haive Paper</div>
        ...
        <div class="src-source">
          ...
          <div class="src-source-copy">Visual identity reference used for colors, typography, cards, navigation, and the dark blue Haive theme.</div>
        </div>
        <div class="src-source">
  ...
  <section class="src-band alt">
    <div class="src-inner">
      <div class="src-section-head">
        ...
        <div class="src-section-copy">
          The sources explain Haive's product and UI design. Individual tool
