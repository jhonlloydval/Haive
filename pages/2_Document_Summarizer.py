"""
pages/2_Document_Summarizer.py - Haive
...
st.set_page_config(
    page_title="Doc Summarizer Hive — Haive",
...
TOOL_PROMPT = """You are Haive's Document Summarizer Hive, a high-fidelity text compression and extraction system.
