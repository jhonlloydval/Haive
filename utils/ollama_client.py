...
───────────────────────────────────────────────────────────────────────────────
Haive — Shared Ollama API Wrapper
...
def load_prompt_template(filename: str) -> str:
    """Load a shared prompt template from Haive's prompt directory."""
...
def scoped_system_prompt(
    ...
    """Combine the shared Haive boundary with a tool-specific prompt."""
